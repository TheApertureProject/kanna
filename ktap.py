botversion = 'v1.0.0 TAP'
# |bot info
# |Username : Kanna#6715
# ¦ID :  467332623677521940
# |Token : NDY3MzMyNjIzNjc3NTIxOTQw.Diz5eA.F8XpE2HAfTPO-naD9WI8DEM2Fkw
...
# |run command : exec(open("/storage/emulated/0/kn.py").read())
...
async def on_member_join(member):
	...
	role1 = discord.utils.get(member.guild.roles, name='Reconstructor III')
	...
	await member.add_roles(role, role1, role2, role3, role4)
...
async def info(ctx):
	'Get to know me !'
	e = discord.Embed(description="Kanna, the Kawaii Discord bot - The Aperture Project edition", title='More about me', color=0xF4A2FF, timestamp=datetime.utcnow())
...
bot.run('NDg1MTU4NDk3OTk5Mzg4NzEx.Dmse4w.IzCvxU73OyQaBaNdWqpc4V1vIJQ')